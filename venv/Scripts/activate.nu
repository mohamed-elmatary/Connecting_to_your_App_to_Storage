...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\Azure\Udacity\Connecting_to_your_App_to_Storage\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\Azure\Udacity\Connecting_to_your_App_to_Storage\venv\Scripts\deactivate.nu'
